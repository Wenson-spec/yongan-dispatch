...
CREATE TABLE IF NOT EXISTS `dispatcher_regions` (
	`id` int AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `freight_stations` (
	`id` int AUTO_INCREMENT NOT NULL,
	`name` varchar(200) NOT NULL,
	`address` text,
	`phone` varchar(20),
...
CREATE TABLE IF NOT EXISTS `ltl_dispatch_batch_orders` (
	`id` int AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ltl_dispatch_batches` (
	`id` int AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ltl_inquiries` (
	`id` int AUTO_INCREMENT NOT NULL,
	`orderId` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `note_change_logs` (
	`id` int AUTO_INCREMENT NOT NULL,
	`orderId` int NOT NULL,
...
ALTER TABLE `orders` ADD COLUMN IF NOT EXISTS `releaseReason` text;
ALTER TABLE `orders` ADD COLUMN IF NOT EXISTS `holdBy` int;
ALTER TABLE `orders` ADD COLUMN IF NOT EXISTS `holdAt` timestamp;
ALTER TABLE `orders` ADD COLUMN IF NOT EXISTS `preHoldStatus` varchar(50);
ALTER TABLE `orders` ADD COLUMN IF NOT EXISTS `preHoldAssignee` int;
